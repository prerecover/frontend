...
export default function AdminStats({
  ...
  return (
    <BoxWrapper
      color="white"
      className="px-[30px] py-[22px] border-none w-full"
    >
      <Text className="text-[22px] font-medium mb-[26px]">
        Работа администратора
      </Text>
      <div className="flex gap-[18px] w-full flex-col">
        <Param
          text="Записей на проверке"
          count={adminStats.inProcessAppointments}
        />
        <Param
        ...
        />
        <Param
          text="Измененных записей"
          count={adminStats.pendingAppointments}
        />
        <Param
          text="Осталось опросов"
          count={adminStats.inProcessAppointments}
        />
      </div>
    </BoxWrapper>
