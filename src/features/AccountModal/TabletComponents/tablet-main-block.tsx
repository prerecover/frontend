  ...
  return (
    <div className="">
      <div className="mobile:bg-white mobile:mt-4 mobile:px-4 mobile:rounded-[12px] tablet:mt-4 tablet:px-4 tablet:rounded-[12px] tablet:bg-white">
        <div className="flex-between items-center mt-3 mb-3">
          <Text type="p" className="text-[16px] font-medium">
            Основная информация
          </Text>
        </div>
        <div className="w-full mt-4 rounded-[12px] transition-all">
          <Form {...form}>
            <form></form>
            <form
              action=""
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full">
                        <FormControl>
                          <div
                            className={cn(
                              'bg-white rounded-[12px] border-solid border-[1px] border-blue flex justify-between relative w-full',
