  ...
  return (
    <>
      <BoxWrapper color="white" className={cn('border-blue-100', className)}>
        ...
        >
          <div className="text-gray-500 font-semibold text-[14px] text-grey-700 mt-[2px]">
            {num}
          </div>
          <div className="flex flex-col">
            <h1 className="font-semibold text-[19px] ">{service?.title}</h1>
            <div className="flex ">
              <h3 className="font-medium text-[#7D7F82] text-[16px]">
                Врачи(и):
              </h3>
            ...
            <div className="flex truncate">
              ...
              <h3 className="font-medium text-[#262626] text-[16px] ml-2">
                {service.durationMin
                  ? durationParse(service.durationMin)
                  : 'Неизвестно'}
              </h3>
            </div>
            <div className="flex">
