...
const ServicesDoctorsMultiselectSearchCell = <M extends EnModes>({
  mode,
  data,
  cellIndex,
  ...props
  ...
  if (mode === undefined) {
    throw new Error(
      `Некорректный мод для ServicesDoctorsMultiselectSearchCell. Было получение ${mode}, а ожидалось одно из значений EnModes`
    );
  }
...
export { ServicesDoctorsMultiselectSearchCell };
