...
export default function ServiceCard({
  ...
  const [service, setService] = useState<Partial<IServiceCreate>>({
    doctors: [],
    paymentMethods: [],
  });
          ...
          <Form {...form}>
            <div className="flex flex-col gap-[18px] w-full">
              ...
              <Input
                ...
                onChange={(e) =>
                  setService({ ...service, title: e.currentTarget.value })
                }
              />
              <Textarea
                placeholder="Описание"
                onChange={(e) =>
                  setService({ ...service, description: e.currentTarget.value })
                }
              />
              ...
              <Select
                onValueChange={(e) =>
                  ...
                  setService({
                    ...service,
                    category: categories.find((el) => el.title === e).title,
                  })
                }
              >
              ...
              {countPaymentMethods.map((_, index) => (
                <Select
                  onValueChange={(e) => changePaymentsState(index, e)}
                  key={index}
                >
                  <SelectTrigger className="w-full py-7 pr-5 pl-6 border-[1px] border-blue-100 bg-[#fff] rounded-[12px]">
              ...
              <Text
                ...
                onClick={() =>
                  setCountPaymentMethods([...countPaymentMethods, ''])
                }
              >
              ...
              <div className="flex-between">
                ...
                <Select
                  onValueChange={(e) => setDurationStatus(e)}
                  defaultValue="диапазон"
                >
              ...
              <div className="flex-between">
                ...
                <Select
                  onValueChange={(e) => setPriceStatus(e)}
                  defaultValue="диапазон"
                >
                  <SelectTrigger className="w-fit py-7 pr-5 pl-6 border-none">
                    <SelectValue className="text-[20px]" />
