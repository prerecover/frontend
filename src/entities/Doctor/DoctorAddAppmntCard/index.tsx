...
export default function DoctorAddAppmntCard({
  doctor,
  active = false,
}: {
  doctor: IDoctor;
  ...
  return (
    <>
      <BoxWrapper
        color="white"
        className={cn(
          'w-full border-blue-100',
          active && 'border-blue border-solid border-[1px]'
        )}
      >
        <div className="flex gap-3 h-full items-center">
          ...
          <div className="flex flex-col">
            ...
            >{`${doctor.lastName} ${doctor.firstName?.charAt(0) + '.'} ${doctor.surname?.charAt(0) + '.'}  `}</Text>
