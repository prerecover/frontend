...
export default function AppointmentNotify({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-blue transition-all flex justify-between rounded-[10px]'
        )}
      ...
      >
        {!open ? (
          ...
          >
            Запись &quot;{appointment.title || 'Без названия'}&quot; на {title}
          </Text>
        ) : (
          <Text
            type="p"
            className={
              'text-white text-[16px] font-medium flex p-4 transition-all'
            }
          >
            Запись &quot;{appointment.title || 'Без названия'}&quot;
          </Text>
        )}
        <Image
          src={
      ...
      {open && (
        <div className="flex flex-col px-4 gap-[20px]">
          ...
          <div className="flex justify-between mr-[80px]">
            ...
            <div className="flex gap-[6px]">
              <Image
                src={'/assets/white-alarm-clock.svg'}
                width={20}
                height={20}
                alt="time"
              />
            ...
            <div className="flex gap-[6px]">
              <Image
                src={'/assets/white-clock-fast-forward.svg'}
                width={20}
                height={20}
                alt="time"
              />
