              ...
              <div key={doctor._id}>
                ...
                >
                  <div className="flex items-center gap-3">
                    <Text
                      type="p"
                      className="text-[11px] font-medium text-grey-700"
                    >
                      {i + 1}
                    </Text>
                    <Image
                    ...
                    <div className="flex flex-col">
                      <div className="flex gap-2">
                        <Text
                          type="h4"
                          className="text-[14px] font-semibold text-dark"
                        >
                          {doctor.firstName}
                        </Text>
                        <Text
                      ...
                      <Text
                        type="p"
                        className="text-[11px] text-grey-700 font-medium"
                      >
