...
export const WifiIcon: FC<PropsWithClassName<PropsWithSize>> = ({ className, width = 24, height = 24 }) => {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 24 24' fill='none'>
            ...
            <path
                ...
                strokeLinejoin='round'
            />
            <path d='M12 20H12.0096' stroke='#262626' strokeWidth='1.25' strokeLinecap='round' strokeLinejoin='round' />
        </svg>
    );
};
