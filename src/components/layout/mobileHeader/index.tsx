  ...
  return (
    <>
      {blockLocation.includes(pathname) ? (
        <div
          className={cn(
            'bg-white p-4 flex-between border-solid fixed border-[1px] border-blue-100 top-0 right-0 left-0 w-full h-[65px] z-30 pc:hidden desktop:hidden',
        ...
        <>
          <div className="flex-between py-0 px-[15px] h-[65px] bg-white border-solid border-[1px] border-blue-100 w-full z-30 fixed top-0 left-0 right-0 desktop:hidden pc:hidden">
            <div className="flex">
              <Image
