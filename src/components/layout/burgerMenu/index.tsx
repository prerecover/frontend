                    ...
                    >
                        {menuData.default.map((item, idx) => (
                            <li
                                ...
                                className={cn("relative cursor-pointer flex items-center p-4 rounded-[12px] border-[1px] border-solid border-[#ebf3ff] mb-[10px] burger_first:py-[9px] burger_first:px-[10px]",
                                    `${item.path == pathname ? "" : ""}`)}
                        ...
                        <li className="relative cursor-pointer flex items-center p-4 rounded-[12px] border-[1px] border-solid border-[#ebf3ff] mb-[10px] burger_first:py-[9px] burger_first:px-[10px]"
                            style={{ display: "flex", justifyContent: "space-between" }} onClick={() => logout()}>
                            <div className="flex gap-4 justify-between w-full">
                                <div className="flex gap-4 items-center burger_first:gap-[10px]">
