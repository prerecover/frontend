...
export const MenuItem: FC<Props> = ({ className, href, icon, title, onClick }) => {
    ...
    return (
        <Link
            className={cn(className, "flex items-center gap-4 text-[14px] font-normal p-[14px]  rounded-[12px] bg-white text-grey w-full transition-all duration-200 ease-in hover:text-dark", styles.wrapper,
