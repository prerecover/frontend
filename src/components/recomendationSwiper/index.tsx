...
export default function RecomendationSwiper({ data }: { data: Search }) {
            ...
            <div className='desktop:mx-auto desktop:w-[1000px] relative flex'>
                ...
                <Swiper
                    ...
                    <>
                        <SwiperSlide>
                            <RecomendationCard
                                service={data.services[Math.floor(Math.random() * data.services.length)]}
                                clinic={data.clinics[Math.floor(Math.random() * data.clinics.length)]}
                                doctor={data.doctors[Math.floor(Math.random() * data.doctors.length)]}
                            />
                        </SwiperSlide>
                        <SwiperSlide>
                            <RecomendationCard
                ...
                <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'>
                    <path d='M0.757359 1.25736L5 5.5L0.757359 9.74264' stroke='#262626' strokeWidth='0.5' />
                </svg>
            </div>
        </>
    );
